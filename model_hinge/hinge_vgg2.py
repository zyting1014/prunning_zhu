...
def set_module_param(module, params):
    ...
    conv11.bias = nn.Parameter(params.bias1)
...
def compress_module_param(module, percentage, threshold, index_pre=None, i=0):
    ...
    pindex1 = get_nonzero_index(weight1, dim='output', counter=1, percentage=percentage, threshold=threshold)[1]
...
def modify_network(net_current):
    ...
    for module_cur in modules[1:]:
        ...
        params = edict({'weight1': weight1, 'bias1': bias1})
...
class Hinge(VGG):
    ...
    def sparse_param(self, module):
        param1 = module.state_dict(keep_vars=True)['0.0.weight']
        ws1 = param1.shape
